...
import com.ajie.config.BoundSql;
import com.ajie.pojo.Configuration;
import com.ajie.pojo.MappedStatement;
import com.ajie.utils.GenericTokenParser;
import com.ajie.utils.ParameterMapping;
import com.ajie.utils.ParameterMappingTokenHandler;
...
public class SimpleExecutor implements Executor {
    ...
    public <E> List<E> query(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        ...
        while (resultSet.next()) {
            ...
            //metaData.getColumnCount() --> 查询结果总列数
